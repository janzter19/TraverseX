...
-- Additive control-database snapshot. TraverseX refreshes this from documents
-- already delivered by its PENDING-only Firebase listeners; opening the Admin
-- report reads this table and performs zero Firebase reads.
